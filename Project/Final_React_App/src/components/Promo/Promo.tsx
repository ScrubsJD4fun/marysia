...
export const Promo: FC<PromoMovieSchema> = ({movie, showButtons = true, onRefresh}) => {
    ...
    return (
        <div className='promo-app'>
            ...
            <div className='promo-block'>
                ...
                <PromoButtons id={movie.id.toString()} trailer={movie.trailerYouTubeId} onRefresh={onRefresh as () => void} showAllButtons={showButtons} />
            </div>
        </div>
    )
}
    ...
    return  (
        <header className='header-app'>
            ...
            <nav className='header-nav'>
                <Link  to={'/'} className='header-nav__link'><span className='header-nav__main'>Главная</span></Link>
                <Link  to={'/genres'} className='header-nav__link'><span className='header-nav__genres'>Жанры
                                        {isMobile ? <SvgGenres /> : ''}
                                    </span></Link>
                <HeaderSearch />
                <HeaderAccount />

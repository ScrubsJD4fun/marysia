...
export const RegisterForm = () => {
  const { errors, register, registerMutation, submitRegistration } =
    useRegistrationForm()
    ...
    <form className="register-form" onSubmit={submitRegistration}>
      <FormField errorMessage={errors.email?.message}>
        <input
          autoComplete="off"
          className={
            errors.email ? "register-form__invalid" : "register-form__valid"
          }
          type="text"
      ...
      <FormField errorMessage={errors.name?.message}>
        <input
          autoComplete="off"
          className={
            errors.name ? "register-form__invalid" : "register-form__valid"
          }
          type="text"
          placeholder="Имя"
          {...register("name", {
      ...
      <FormField errorMessage={errors.surname?.message}>
        <input
          autoComplete="off"
          className={
            errors.surname ? "register-form__invalid" : "register-form__valid"
          }
          type="text"
          placeholder="Фамилия"
          {...register("surname", {
      ...
      <FormField errorMessage={errors.password?.message}>
        <input
          autoComplete="off"
          className={
            errors.password ? "register-form__invalid" : "register-form__valid"
          }
          type="password"
          placeholder="Пароль"
          {...register("password", {
      ...
      <FormField>
        <input
          ...
          className={
            isPasswordsValid ? "register-form__valid" : "register-form__invalid"
          }
      ...
      <Button title="Зарегистрироваться" isLoading={registerMutation.isPending}>
        Создать аккаунт
      </Button>
    </form>
  )

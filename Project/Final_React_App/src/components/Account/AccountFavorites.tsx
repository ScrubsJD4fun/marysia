                ...
                <ul className="list-reset favor-list">
                    {meFavorites.data.map((film: Movie) => (
                        <li className="favor-item" key={film.id}>
                                <Link className='favor-root'  key={film.id} to={`/films/${film.id}`}>
                                    <img className="favor-poster" src={film.posterUrl} alt={film.title} />
                                </Link>
                                <button className='favor-button' onClick={() => deleteFavoritesHandler(film.id)} ></button>
                            </li>
                    ))}
                </ul>
            )
